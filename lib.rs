...
mod test {
    ...
    fn test_counter() {
        ...
        println!("Counter after increment: {}", CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter);
        ...
        println!("Counter after decrement: {}", CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter);
        ...
        println!("Counter after update: {}", CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter);
        ...
        println!("Counter after reset: {}", CounterAccount::try_from_slice(&accounts[0].data.borrow()).unwrap().counter);
